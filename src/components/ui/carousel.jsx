...
const CarouselItem = React.forwardRef(({ className, orientation, ...props }, ref) => {
  return (
    <div
      ref={ref}
      role="group"
  ...
  return (
    <div
      className={cn(
        ...
        'flex mt-8 items-center justify-center gap-2',
        className,
      )}
      {...props}
    >
      {api?.scrollSnapList().map((_, index) => (
        <Button
          ...
          size="icon"
          className={cn(
            'embla__dot size-2 rounded-full border border-primary',
            index === selectedIndex
              ? 'embla__dot--selected'
              : 'bg-primary/15',
          )}
